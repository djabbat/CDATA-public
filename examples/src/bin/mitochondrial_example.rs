...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("{:<6} {:<12} {:>7} {:>8} {:>7} {:>8} {:>7} {:>7} {:>8} {:>7}",
             "Year", "Stage", "Damage", "Spindle", "mtDNA", "mitoROS", "Fusion", "Shield", "periDens", "mBias");
    println!("{}", "-".repeat(84));
...
fn print_state(sim: &SimulationManager, year: u32) {
    ...
    let n = count as f32;
    print!("{:<6} {:<12} {:>7.3} {:>8.3} {:>7.3} {:>8.3} {:>7.3} {:>7.3} {:>8.3} {:>7.3}",
           year, stage_str,
