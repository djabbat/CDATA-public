...
- Frailty = 0.5 × damage + 0.3 × SASP + 0.2 × (1 − stem pool)
...
""",
        ...
        "about_limits": "**Known limitations:** ROS saturation calibration ongoing; frailty flat >60yr under some presets; differentiated-cell telomere dynamics not modelled.",
        # Parameter labels
...
""",
        ...
        "about_limits": "**Limites connues:** Calibration ROS en cours; fragilité plate >60 ans sous certains préréglages.",
...
""",
        ...
        "about_limits": "**Limitaciones:** Calibración de ROS en curso; fragilidad plana >60 años en algunos presets.",
...
""",
        ...
        "about_limits": "**القيود المعروفة:** معايرة ROS جارية؛ الهشاشة مسطحة بعد 60 عامًا في بعض الإعدادات.",
...
""",
        ...
        "about_limits": "**已知局限：** ROS饱和校准进行中；某些预设下60岁以上虚弱指数趋于平缓。",
        "alpha":        "α — 每次分裂的损伤量",
        "pi0":          "π₀ — 青春保护因子",
        "tau":          "τ — 保护半衰期（年）",
        "nu":           "ν — 每年分裂次数",
...
""",
        ...
        "about_limits": "**Известные ограничения:** Калибровка ROS продолжается; frailty может быть плоским после 60 лет при некоторых пресетах; динамика теломер дифференцированных клеток не смоделирована.",
...
""",
        ...
        "about_limits": "**ცნობილი შეზღუდვები:** ROS კალიბრაცია მიმდინარეობს; სისუსტე 60 წლის შემდეგ ზოგიერთ პრესეტში.",
...
def run_simulation(p: Params, years: int = 100):
    ...
    telomere = 1.0; epigenetic = 0.0; frailty = 0.0
    ...
    for year in range(years + 1):
        ...
        # Telomerase intervention has no effect in this stem-cell model.
        ...
        # Frailty: telomere term removed (stays at 1.0 in stem cells), weight on damage increased
        frailty   = min(damage * 0.5 + sasp * 0.3 + (1.0 - pool) * 0.2, 1.0)
